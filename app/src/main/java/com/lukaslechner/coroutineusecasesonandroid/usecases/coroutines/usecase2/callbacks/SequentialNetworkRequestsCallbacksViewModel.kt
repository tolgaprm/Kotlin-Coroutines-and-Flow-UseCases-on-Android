        ...
        getAndroidVersionsCall!!.enqueue(object : Callback<List<AndroidVersion>> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    getAndroidFeaturesCall = mockApi.getAndroidVersionFeatures(apiLevel = mostRecentVersion.apiLevel)
                    getAndroidFeaturesCall!!.enqueue(object : Callback<VersionFeatures> {
                        override fun onResponse(
                            ...
                            if (response.isSuccessful) {
                                ...
                                uiState.value =
                                    UiState.Success(versionFeatures = featuresOfMostRecentVersion)
                            } else {
